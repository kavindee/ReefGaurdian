  ...
  return (
    <div className="flex items-center justify-center h-screen bg-indigo-50" style={{
      ...
      backgroundAttachment: "fixed",
            ...
            <div className="w-full max-w-md p-4 bg-white rounded-lg shadow-md backdrop-blur-md" style={{ backgroundColor: "rgba(255, 255, 255, 0.9)" }}>
              ...
              <h2 className="text-lg text-secondary mb-6">Join our community now!</h2>
                <TEInput
                  type="text"
                  label="User's Name"
                  size="md"
