...
import backgroundImg from "../images/bck2.jpeg";
...
export default function Login() {
 ...
 const handleGoogleLogin = async () => {
  ...
  return (
    <div className="bg-indigo-50 flex h-screen justify-center items-center" style={{
      ...
      backgroundAttachment: "fixed",
          ...
          <div className="w-full max-w-lg p-6 space-y-8 rounded-xl bg-white backdrop-blur-lg shadow-lg" style={{ backgroundColor: "rgba(255, 255, 255, 0.8)" }}>
              ...
              <h2 className="text-lg text-secondary mb-6">Explore the world now!</h2>
                <TEInput
                  type="email"
                  label="Email address"
                  size="lg"
